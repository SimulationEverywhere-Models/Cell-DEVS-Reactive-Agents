...
%*****************NEIGHBOR PORTS*******************%
neighborports : occ celltype comfort desire
...
rule : { ~celltype:= $cell;
		...
		~occ:= $agent + #macro(COMFORT_LEVEL); } { $agent:= 0; } 10
							{ (0,0)~occ >= 1					% cell is occupied
...
rule : { ~celltype:= $cell;
		~comfort:= #macro(COMFORT_LEVEL);
		~desire:=  #macro(DESIRABILITY); 
		~occ:= $agent + #macro(COMFORT_LEVEL); } { $agent:= 0; } { if( (0,0)~comfort >= 0.80, 10, if( (0,0)~comfort >= 0.50 , 30 , if( (0,0)~comfort >= 0.10, 70, 100 ) ) ) }
							{ (0,0)~occ >= 1
...
rule : { ~celltype:= $cell;
		~comfort:= #macro(COMFORT_LEVEL);
		~desire:=  #macro(DESIRABILITY); 
		~occ:= $agent + #macro(COMFORT_LEVEL); } { $agent:= 1; } { if( (0,-1)~comfort >= 0.80, 10, if( (0,-1)~comfort >= 0.50 , 30 , if( (0,-1)~comfort >= 0.10, 70, 100 ) ) ) }
							{ (0,0)~occ < 1
...
rule : { ~celltype:= $cell;
		~comfort:= #macro(COMFORT_LEVEL);
		~desire:=  #macro(DESIRABILITY); 
		~occ:= $agent + #macro(COMFORT_LEVEL); } { $agent:= 1; } { if( (1,-1)~comfort >= 0.80, 10, if( (1,-1)~comfort >= 0.50 , 30 , if( (1,-1)~comfort >= 0.10, 70, 100 ) ) ) }
							{ (0,0)~occ < 1
							and (1,-1)~occ >= 1
...
rule : { ~celltype:= $cell;
		~comfort:= #macro(COMFORT_LEVEL);
		~desire:=  #macro(DESIRABILITY); 
		~occ:= $agent + #macro(COMFORT_LEVEL); } { $agent:= 1; } { if( (1,0)~comfort >= 0.80, 10, if( (1,0)~comfort >= 0.50 , 30 , if( (1,0)~comfort >= 0.10, 70, 100 ) ) ) }
							{ (0,0)~occ < 1
							and (1,0)~occ >= 1
...
rule : { ~celltype:= $cell;
		~comfort:= #macro(COMFORT_LEVEL);
		~desire:=  #macro(DESIRABILITY); 
		~occ:= $agent + #macro(COMFORT_LEVEL); } { if( (0,0)~comfort >= 0.80, 10, if( (0,0)~comfort >= 0.50 , 30 , if( (0,0)~comfort >= 0.10, 70, 100 ) ) ) } 	{ t }