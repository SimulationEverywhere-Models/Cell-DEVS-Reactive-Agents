...
rule : { ~occ:= $cell; 
		...
		~desire:=  #macro(DESIRABILITY); } { $agent:= 0; } { 100 - round((0,0)~comfort_human*100) } 
...
rule : { ~occ:= $agent + $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 1; } { 100 - round((0,-1)~comfort_human*100) }  
							{ (0,0)~occ < 1
...
rule : { ~occ:= $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 0; } { 100 - round((0,0)~comfort_mons*100) } 
...
rule : { ~occ:= $agent + $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 2; } { 100 - round((0,-1)~comfort_mons*100) }  
							{ (0,0)~occ < 1
...
rule : { ~occ:= $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 0; } { 100 - round((0,0)~comfort_alien*100) } 
...
rule : { ~occ:= $agent + $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 3; } { 100 - round((0,-1)~comfort_alien*100) }  
							{ (0,0)~occ < 1
...
rule : { ~occ:= $agent + $cell;
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 1; } { 100 - round((1,-1)~comfort_human*100) }  	
							{ (0,0)~occ < 1
...
rule : { ~occ:= $agent + $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 2; } { 100 - round((1,-1)~comfort_mons*100) }  	
							{ (0,0)~occ < 1
...
rule : { ~occ:= $agent + $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 3; } { 100 - round((1,-1)~comfort_alien*100) }  	
							{ (0,0)~occ < 1
...
rule : { ~occ:= $agent + $cell;
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 1; } { 100 - round((1,0)~comfort_human*100) } 	
							{ (0,0)~occ < 1
...
rule : { ~occ:= $agent + $cell; 
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 2; } { 100 - round((1,0)~comfort_mons*100) } 	
							{ (0,0)~occ < 1
...
rule : { ~occ:= $agent + $cell;
		...
		~comfort_mons:= #macro(COMFORT_LV_MONS);
		~comfort_alien:= #macro(COMFORT_LV_ALIEN);
		~desire:=  #macro(DESIRABILITY); } { $agent:= 3; } { 100 - round((1,0)~comfort_alien*100) } 	
							{ (0,0)~occ < 1
